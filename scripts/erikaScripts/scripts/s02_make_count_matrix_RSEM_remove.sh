...
$TRINITY_HOME/util/abundance_estimates_to_matrix.pl --est_method RSEM --gene_trans_map /scratch/erikamr/cyano_chytrid_met/data/filtered_gene_trans_map_cds.txt --out_prefix RSEM_remove --name_sample_by_basedir --quant_files /scratch/erikamr/cyano_chytrid_met/data/quant_file_isoform_remove.txt --min_tpm 0
