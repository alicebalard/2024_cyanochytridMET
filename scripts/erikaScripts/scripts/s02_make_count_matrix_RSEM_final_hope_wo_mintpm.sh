...
$TRINITY_HOME/util/abundance_estimates_to_matrix.pl --est_method RSEM --gene_trans_map /scratch/erikamr/cyano_chytrid_met/data/combined_gene_trans_map_cds_final_hope.txt --out_prefix RSEM_final_hope_wo_mintpm --name_sample_by_basedir --quant_files /scratch/erikamr/cyano_chytrid_met/data/quant_file_isoform_final_hope.txt
