...
ASSEMBLY_BOTH=/scratch/erikamr/cyano_chytrid_met/data/assembly_both_cds_reassembly.fna

$TRINITY_HOME/util/align_and_estimate_abundance.pl --transcripts $ASSEMBLY_BOTH --seqType fq --samples_file /scratch/erikamr/cyano_chytrid_met/data/samples_file_remove.txt --est_method RSEM --aln_method bowtie --bowtie_RSEM "--no-unal -k 20" --thread_count 16 --output_dir /scratch/erikamr/cyano_chytrid_met/data/out_trinity_align_rsem_reassembly --gene_trans_map /scratch/erikamr/cyano_chytrid_met/data/combined_gene_trans_map_cds_reassembly.txt  --prep_reference 
