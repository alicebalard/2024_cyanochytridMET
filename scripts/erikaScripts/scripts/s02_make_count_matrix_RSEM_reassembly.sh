...
$TRINITY_HOME/util/abundance_estimates_to_matrix.pl --est_method RSEM --gene_trans_map /scratch/erikamr/cyano_chytrid_met/data/combined_gene_trans_map_cds_reassembly.txt --out_prefix RSEM_reassembly --name_sample_by_basedir --quant_files /scratch/erikamr/cyano_chytrid_met/data/quant_file_isoform_reassembly.txt --min_tpm 0
