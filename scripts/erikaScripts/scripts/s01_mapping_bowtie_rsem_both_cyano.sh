...
OUTPUT_DIR=/scratch/erikamr/cyano_chytrid_met/data/out_trinity_align_rsem_both_cyano

$TRINITY_HOME/util/align_and_estimate_abundance.pl --transcripts $ASSEMBLY_CYANO --seqType fq --samples_file /scratch/erikamr/cyano_chytrid_met/data/samples_file_both.txt --est_method RSEM --aln_method bowtie --bowtie_RSEM "--no-unal -k 20" --thread_count 16 --output_dir $OUTPUT_DIR --gene_trans_map /scratch/erikamr/cyano_chytrid_met/data/gene_trans_map_cds.txt --prep_reference 
