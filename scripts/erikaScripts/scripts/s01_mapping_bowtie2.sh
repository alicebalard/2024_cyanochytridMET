...
OUTPUT_DIR=/scratch/erikamr/cyano_chytrid_met/data/out_trinity_align_rsem_concatenated_bowtie2

$TRINITY_HOME/util/align_and_estimate_abundance.pl --transcripts $ASSEMBLY_BOTH --seqType fq --samples_file /scratch/erikamr/cyano_chytrid_met/data/samples_file.txt --est_method RSEM --aln_method bowtie2 --bowtie2_RSEM "--no-unal -k 10" --thread_count 8 --output_dir $OUTPUT_DIR --gene_trans_map /scratch/erikamr/cyano_chytrid_met/data/filtered_gene_trans_map_cds.txt --prep_reference 
