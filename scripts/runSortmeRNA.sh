...
## We want to clean samples Z1 to Z12 (only chytrid) after kraken2 decontamination
rawDir=/scratch/alicebalard/outData/kraken2decontamination/out/
extension="_unclassified_raw_reads_"
...
FILEF="${rawDir}${sample}${extension}1.fq"    
FILER="${rawDir}${sample}${extension}2.fq"
